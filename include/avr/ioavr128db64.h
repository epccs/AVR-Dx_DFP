...
#  define _AVR_IOXXX_H_ "ioavr128db64.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_AVR128DB64_H_INCLUDED
#define _AVR_AVR128DB64_H_INCLUDED
...
typedef struct EVSYS_struct
{
    ...
    register8_t USEREVSYSEVOUTB;  /* User 14 - EVOUTB */
    register8_t USEREVSYSEVOUTC;  /* User 15 - EVOUTC */
    register8_t USEREVSYSEVOUTD;  /* User 16 - EVOUTD */
    register8_t USEREVSYSEVOUTE;  /* User 17 - EVOUTE */
    register8_t USEREVSYSEVOUTF;  /* User 18 - EVOUTF */
    register8_t USEREVSYSEVOUTG;  /* User 19 - EVOUTG */
    register8_t USERUSART0IRDA;  /* User 20 - USART0 */
    register8_t USERUSART1IRDA;  /* User 21 - USART1 */
    register8_t USERUSART2IRDA;  /* User 22 - USART2 */
    register8_t USERUSART3IRDA;  /* User 23 - USART3 */
    register8_t USERUSART4IRDA;  /* User 24 - USART4 */
    register8_t USERUSART5IRDA;  /* User 25 - USART5 */
    register8_t USERTCA0CNTA;  /* User 26 - TCA0 Event A */
    register8_t USERTCA0CNTB;  /* User 27 - TCA0 Event B */
    register8_t USERTCA1CNTA;  /* User 28 - TCA1 Event A */
    register8_t USERTCA1CNTB;  /* User 29 - TCA1 Event B */
    ...
    register8_t USERTCB3CAPT;  /* User 36 - TCB3 Event A */
    register8_t USERTCB3COUNT;  /* User 37 - TCB3 Event B */
    register8_t USERTCB4CAPT;  /* User 38 - TCB4 Event A */
    register8_t USERTCB4COUNT;  /* User 39 - TCB4 Event B */
    register8_t USERTCD0INPUTA;  /* User 40 - TCD0 Event A */
    register8_t USERTCD0INPUTB;  /* User 41 - TCD0 Event B */
    register8_t USEROPAMP0ENABLE;  /* User 42 - OPAMP0 Enable */
    register8_t USEROPAMP0DISABLE;  /* User 43 - OPAMP0 Disable */
    register8_t USEROPAMP0DUMP;  /* User 44 - OPAMP0 Dump */
    register8_t USEROPAMP0DRIVE;  /* User 45 - OPAMP0 Drive */
    register8_t USEROPAMP1ENABLE;  /* User 46 - OPAMP1 Enable */
    register8_t USEROPAMP1DISABLE;  /* User 47 - OPAMP1 Disable */
    register8_t USEROPAMP1DUMP;  /* User 48 - OPAMP1 Dump */
    register8_t USEROPAMP1DRIVE;  /* User 49 - OPAMP1 Drive */
    register8_t USEROPAMP2ENABLE;  /* User 50 - OPAMP2 Enable */
    register8_t USEROPAMP2DISABLE;  /* User 51 - OPAMP2 Disable */
    register8_t USEROPAMP2DUMP;  /* User 52 - OPAMP2 Dump */
    register8_t USEROPAMP2DRIVE;  /* User 53 - OPAMP2 Drive */
} EVSYS_t;
...
typedef enum EVSYS_CHANNEL5_enum
{
    ...
    EVSYS_CHANNEL5_PORTE_PIN7_gc = (0x47<<0),  /* Port E Pin 7 */
...
/* TCB4 Output select */
typedef enum PORTMUX_TCB4_enum
{
    PORTMUX_TCB4_DEFAULT_gc = (0x00<<4),  /* WO on PG3 */
    PORTMUX_TCB4_ALT1_gc = (0x01<<4),  /* WO on PC6 */
} PORTMUX_TCB4_t;
...
typedef enum PORTMUX_USART5_enum
{
    PORTMUX_USART5_DEFAULT_gc = (0x00<<2),  /* PG0, PG1, PG2, PG3 */
    PORTMUX_USART5_ALT1_gc = (0x01<<2),  /* PG4, PG5, PG6, PG7 */
    PORTMUX_USART5_NONE_gc = (0x03<<2),  /* Not connected to any pins */
} PORTMUX_USART5_t;
...
{
    PORTMUX_ZCD2_DEFAULT_gc = (0x00<<2),  /* OUT on PA7 */
    PORTMUX_ZCD2_ALT1_gc = (0x01<<2),  /* OUT on PC7 */
} PORTMUX_ZCD2_t;
...
#define EVSYS_USEREVSYSEVOUTA  _SFR_MEM8(0x022D)
#define EVSYS_USEREVSYSEVOUTB  _SFR_MEM8(0x022E)
#define EVSYS_USEREVSYSEVOUTC  _SFR_MEM8(0x022F)
#define EVSYS_USEREVSYSEVOUTD  _SFR_MEM8(0x0230)
#define EVSYS_USEREVSYSEVOUTE  _SFR_MEM8(0x0231)
#define EVSYS_USEREVSYSEVOUTF  _SFR_MEM8(0x0232)
#define EVSYS_USEREVSYSEVOUTG  _SFR_MEM8(0x0233)
#define EVSYS_USERUSART0IRDA  _SFR_MEM8(0x0234)
#define EVSYS_USERUSART1IRDA  _SFR_MEM8(0x0235)
#define EVSYS_USERUSART2IRDA  _SFR_MEM8(0x0236)
#define EVSYS_USERUSART3IRDA  _SFR_MEM8(0x0237)
#define EVSYS_USERUSART4IRDA  _SFR_MEM8(0x0238)
#define EVSYS_USERUSART5IRDA  _SFR_MEM8(0x0239)
#define EVSYS_USERTCA0CNTA  _SFR_MEM8(0x023A)
#define EVSYS_USERTCA0CNTB  _SFR_MEM8(0x023B)
#define EVSYS_USERTCA1CNTA  _SFR_MEM8(0x023C)
#define EVSYS_USERTCA1CNTB  _SFR_MEM8(0x023D)
...
#define EVSYS_USERTCB4CAPT  _SFR_MEM8(0x0246)
#define EVSYS_USERTCB4COUNT  _SFR_MEM8(0x0247)
#define EVSYS_USERTCD0INPUTA  _SFR_MEM8(0x0248)
#define EVSYS_USERTCD0INPUTB  _SFR_MEM8(0x0249)
#define EVSYS_USEROPAMP0ENABLE  _SFR_MEM8(0x024A)
#define EVSYS_USEROPAMP0DISABLE  _SFR_MEM8(0x024B)
#define EVSYS_USEROPAMP0DUMP  _SFR_MEM8(0x024C)
#define EVSYS_USEROPAMP0DRIVE  _SFR_MEM8(0x024D)
#define EVSYS_USEROPAMP1ENABLE  _SFR_MEM8(0x024E)
#define EVSYS_USEROPAMP1DISABLE  _SFR_MEM8(0x024F)
#define EVSYS_USEROPAMP1DUMP  _SFR_MEM8(0x0250)
#define EVSYS_USEROPAMP1DRIVE  _SFR_MEM8(0x0251)
#define EVSYS_USEROPAMP2ENABLE  _SFR_MEM8(0x0252)
#define EVSYS_USEROPAMP2DISABLE  _SFR_MEM8(0x0253)
#define EVSYS_USEROPAMP2DUMP  _SFR_MEM8(0x0254)
#define EVSYS_USEROPAMP2DRIVE  _SFR_MEM8(0x0255)
...
#define OPAMP_TIMEBASE  _SFR_MEM8(0x0702)
#define OPAMP_PWRCTRL  _SFR_MEM8(0x070F)
...
#define OPAMP_OP2CTRLA  _SFR_MEM8(0x0720)
#define OPAMP_OP2STATUS  _SFR_MEM8(0x0721)
#define OPAMP_OP2RESMUX  _SFR_MEM8(0x0722)
#define OPAMP_OP2INMUX  _SFR_MEM8(0x0723)
#define OPAMP_OP2SETTLE  _SFR_MEM8(0x0724)
#define OPAMP_OP2CAL  _SFR_MEM8(0x0725)
...
#define CLKCTRL_CFDSRC0_bm  (1<<2)  /* Clock Failure Detect Source bit 0 mask. */
#define CLKCTRL_CFDSRC0_bp  2  /* Clock Failure Detect Source bit 0 position. */
#define CLKCTRL_CFDSRC1_bm  (1<<3)  /* Clock Failure Detect Source bit 1 mask. */
#define CLKCTRL_CFDSRC1_bp  3  /* Clock Failure Detect Source bit 1 position. */
...
#define CLKCTRL_FRQRANGE0_bm  (1<<2)  /* Frequency Range bit 0 mask. */
#define CLKCTRL_FRQRANGE0_bp  2  /* Frequency Range bit 0 position. */
#define CLKCTRL_FRQRANGE1_bm  (1<<3)  /* Frequency Range bit 1 mask. */
#define CLKCTRL_FRQRANGE1_bp  3  /* Frequency Range bit 1 position. */
...
#define CLKCTRL_CSUTHF0_bm  (1<<4)  /* Start-up Time Select bit 0 mask. */
#define CLKCTRL_CSUTHF0_bp  4  /* Start-up Time Select bit 0 position. */
#define CLKCTRL_CSUTHF1_bm  (1<<5)  /* Start-up Time Select bit 1 mask. */
#define CLKCTRL_CSUTHF1_bp  5  /* Start-up Time Select bit 1 position. */
...
/* EVSYS.USEROPAMP0ENABLE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP0DISABLE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP0DUMP  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP0DRIVE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP1ENABLE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP1DISABLE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP1DUMP  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP1DRIVE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP2ENABLE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP2DISABLE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP2DUMP  bit masks and bit positions */
/* EVSYS_USER  is already defined. */

/* EVSYS.USEROPAMP2DRIVE  bit masks and bit positions */
/* EVSYS_USER  is already defined. */
...
#define FUSE_MVSYSCFG0_bm  (1<<3)  /* MVIO System Configuration bit 0 mask. */
#define FUSE_MVSYSCFG0_bp  3  /* MVIO System Configuration bit 0 position. */
#define FUSE_MVSYSCFG1_bm  (1<<4)  /* MVIO System Configuration bit 1 mask. */
#define FUSE_MVSYSCFG1_bp  4  /* MVIO System Configuration bit 1 position. */
...
/* OPAMP.TIMEBASE  bit masks and bit positions */
#define OPAMP_TIMEBASE_gm  0x7F  /* Timebase Value group mask. */
#define OPAMP_TIMEBASE_gp  0  /* Timebase Value group position. */
#define OPAMP_TIMEBASE0_bm  (1<<0)  /* Timebase Value bit 0 mask. */
#define OPAMP_TIMEBASE0_bp  0  /* Timebase Value bit 0 position. */
#define OPAMP_TIMEBASE1_bm  (1<<1)  /* Timebase Value bit 1 mask. */
#define OPAMP_TIMEBASE1_bp  1  /* Timebase Value bit 1 position. */
#define OPAMP_TIMEBASE2_bm  (1<<2)  /* Timebase Value bit 2 mask. */
#define OPAMP_TIMEBASE2_bp  2  /* Timebase Value bit 2 position. */
#define OPAMP_TIMEBASE3_bm  (1<<3)  /* Timebase Value bit 3 mask. */
#define OPAMP_TIMEBASE3_bp  3  /* Timebase Value bit 3 position. */
#define OPAMP_TIMEBASE4_bm  (1<<4)  /* Timebase Value bit 4 mask. */
#define OPAMP_TIMEBASE4_bp  4  /* Timebase Value bit 4 position. */
#define OPAMP_TIMEBASE5_bm  (1<<5)  /* Timebase Value bit 5 mask. */
#define OPAMP_TIMEBASE5_bp  5  /* Timebase Value bit 5 position. */
#define OPAMP_TIMEBASE6_bm  (1<<6)  /* Timebase Value bit 6 mask. */
#define OPAMP_TIMEBASE6_bp  6  /* Timebase Value bit 6 position. */

/* OPAMP.PWRCTRL  bit masks and bit positions */
#define OPAMP_IRSEL_bm  0x01  /* Input Range Select bit mask. */
#define OPAMP_IRSEL_bp  0  /* Input Range Select bit position. */
...
#define OPAMP_OUTMODE_gm  0x0C  /* Output Mode group mask. */
#define OPAMP_OUTMODE_gp  2  /* Output Mode group position. */
#define OPAMP_OUTMODE0_bm  (1<<2)  /* Output Mode bit 0 mask. */
#define OPAMP_OUTMODE0_bp  2  /* Output Mode bit 0 position. */
#define OPAMP_OUTMODE1_bm  (1<<3)  /* Output Mode bit 1 mask. */
#define OPAMP_OUTMODE1_bp  3  /* Output Mode bit 1 position. */
...
#define OPAMP_MUXTOP0_bm  (1<<0)  /* Multiplexer Top bit 0 mask. */
#define OPAMP_MUXTOP0_bp  0  /* Multiplexer Top bit 0 position. */
#define OPAMP_MUXTOP1_bm  (1<<1)  /* Multiplexer Top bit 1 mask. */
#define OPAMP_MUXTOP1_bp  1  /* Multiplexer Top bit 1 position. */
#define OPAMP_MUXBOT_gm  0x1C  /* Multiplexer Bottom group mask. */
#define OPAMP_MUXBOT_gp  2  /* Multiplexer Bottom group position. */
#define OPAMP_MUXBOT0_bm  (1<<2)  /* Multiplexer Bottom bit 0 mask. */
#define OPAMP_MUXBOT0_bp  2  /* Multiplexer Bottom bit 0 position. */
#define OPAMP_MUXBOT1_bm  (1<<3)  /* Multiplexer Bottom bit 1 mask. */
#define OPAMP_MUXBOT1_bp  3  /* Multiplexer Bottom bit 1 position. */
#define OPAMP_MUXBOT2_bm  (1<<4)  /* Multiplexer Bottom bit 2 mask. */
#define OPAMP_MUXBOT2_bp  4  /* Multiplexer Bottom bit 2 position. */
...
#define OPAMP_MUXWIP0_bm  (1<<5)  /* Multiplexer Wiper selector bit 0 mask. */
#define OPAMP_MUXWIP0_bp  5  /* Multiplexer Wiper selector bit 0 position. */
#define OPAMP_MUXWIP1_bm  (1<<6)  /* Multiplexer Wiper selector bit 1 mask. */
#define OPAMP_MUXWIP1_bp  6  /* Multiplexer Wiper selector bit 1 position. */
#define OPAMP_MUXWIP2_bm  (1<<7)  /* Multiplexer Wiper selector bit 2 mask. */
#define OPAMP_MUXWIP2_bp  7  /* Multiplexer Wiper selector bit 2 position. */

/* OPAMP.OP0INMUX  bit masks and bit positions */
#define OPAMP_MUXPOS_gm  0x07  /* Positive Input Multiplexer group mask. */
#define OPAMP_MUXPOS_gp  0  /* Positive Input Multiplexer group position. */
#define OPAMP_MUXPOS0_bm  (1<<0)  /* Positive Input Multiplexer bit 0 mask. */
#define OPAMP_MUXPOS0_bp  0  /* Positive Input Multiplexer bit 0 position. */
#define OPAMP_MUXPOS1_bm  (1<<1)  /* Positive Input Multiplexer bit 1 mask. */
#define OPAMP_MUXPOS1_bp  1  /* Positive Input Multiplexer bit 1 position. */
#define OPAMP_MUXPOS2_bm  (1<<2)  /* Positive Input Multiplexer bit 2 mask. */
#define OPAMP_MUXPOS2_bp  2  /* Positive Input Multiplexer bit 2 position. */
#define OPAMP_MUXNEG_gm  0x70  /* Negative Input Multiplexer group mask. */
#define OPAMP_MUXNEG_gp  4  /* Negative Input Multiplexer group position. */
#define OPAMP_MUXNEG0_bm  (1<<4)  /* Negative Input Multiplexer bit 0 mask. */
#define OPAMP_MUXNEG0_bp  4  /* Negative Input Multiplexer bit 0 position. */
#define OPAMP_MUXNEG1_bm  (1<<5)  /* Negative Input Multiplexer bit 1 mask. */
#define OPAMP_MUXNEG1_bp  5  /* Negative Input Multiplexer bit 1 position. */
#define OPAMP_MUXNEG2_bm  (1<<6)  /* Negative Input Multiplexer bit 2 mask. */
#define OPAMP_MUXNEG2_bp  6  /* Negative Input Multiplexer bit 2 position. */
...
#define OPAMP_SETTLE0_bm  (1<<0)  /* Settle Time bit 0 mask. */
#define OPAMP_SETTLE0_bp  0  /* Settle Time bit 0 position. */
#define OPAMP_SETTLE1_bm  (1<<1)  /* Settle Time bit 1 mask. */
#define OPAMP_SETTLE1_bp  1  /* Settle Time bit 1 position. */
#define OPAMP_SETTLE2_bm  (1<<2)  /* Settle Time bit 2 mask. */
#define OPAMP_SETTLE2_bp  2  /* Settle Time bit 2 position. */
#define OPAMP_SETTLE3_bm  (1<<3)  /* Settle Time bit 3 mask. */
#define OPAMP_SETTLE3_bp  3  /* Settle Time bit 3 position. */
#define OPAMP_SETTLE4_bm  (1<<4)  /* Settle Time bit 4 mask. */
#define OPAMP_SETTLE4_bp  4  /* Settle Time bit 4 position. */
#define OPAMP_SETTLE5_bm  (1<<5)  /* Settle Time bit 5 mask. */
#define OPAMP_SETTLE5_bp  5  /* Settle Time bit 5 position. */
#define OPAMP_SETTLE6_bm  (1<<6)  /* Settle Time bit 6 mask. */
#define OPAMP_SETTLE6_bp  6  /* Settle Time bit 6 position. */
...
#define OPAMP_CAL0_bm  (1<<0)  /* Calibration (for input offset voltage) bit 0 mask. */
#define OPAMP_CAL0_bp  0  /* Calibration (for input offset voltage) bit 0 position. */
#define OPAMP_CAL1_bm  (1<<1)  /* Calibration (for input offset voltage) bit 1 mask. */
#define OPAMP_CAL1_bp  1  /* Calibration (for input offset voltage) bit 1 position. */
#define OPAMP_CAL2_bm  (1<<2)  /* Calibration (for input offset voltage) bit 2 mask. */
#define OPAMP_CAL2_bp  2  /* Calibration (for input offset voltage) bit 2 position. */
#define OPAMP_CAL3_bm  (1<<3)  /* Calibration (for input offset voltage) bit 3 mask. */
#define OPAMP_CAL3_bp  3  /* Calibration (for input offset voltage) bit 3 position. */
#define OPAMP_CAL4_bm  (1<<4)  /* Calibration (for input offset voltage) bit 4 mask. */
#define OPAMP_CAL4_bp  4  /* Calibration (for input offset voltage) bit 4 position. */
#define OPAMP_CAL5_bm  (1<<5)  /* Calibration (for input offset voltage) bit 5 mask. */
#define OPAMP_CAL5_bp  5  /* Calibration (for input offset voltage) bit 5 position. */
#define OPAMP_CAL6_bm  (1<<6)  /* Calibration (for input offset voltage) bit 6 mask. */
#define OPAMP_CAL6_bp  6  /* Calibration (for input offset voltage) bit 6 position. */
#define OPAMP_CAL7_bm  (1<<7)  /* Calibration (for input offset voltage) bit 7 mask. */
#define OPAMP_CAL7_bp  7  /* Calibration (for input offset voltage) bit 7 position. */
...
/* OPAMP.OP2CTRLA  bit masks and bit positions */
/* OPAMP_ALWAYSON  is already defined. */
/* OPAMP_EVENTEN  is already defined. */
/* OPAMP_OUTMODE  is already defined. */
/* OPAMP_RUNSTBY  is already defined. */

/* OPAMP.OP2STATUS  bit masks and bit positions */
/* OPAMP_SETTLED  is already defined. */

/* OPAMP.OP2RESMUX  bit masks and bit positions */
/* OPAMP_MUXTOP  is already defined. */
/* OPAMP_MUXBOT  is already defined. */
/* OPAMP_MUXWIP  is already defined. */

/* OPAMP.OP2INMUX  bit masks and bit positions */
/* OPAMP_MUXPOS  is already defined. */
/* OPAMP_MUXNEG  is already defined. */

/* OPAMP.OP2SETTLE  bit masks and bit positions */
/* OPAMP_SETTLE  is already defined. */

/* OPAMP.OP2CAL  bit masks and bit positions */
/* OPAMP_CAL  is already defined. */
...
#define PORTMUX_USART5_gm  0x0C  /* USART5 Signals group mask. */
#define PORTMUX_USART5_gp  2  /* USART5 Signals group position. */
#define PORTMUX_USART50_bm  (1<<2)  /* USART5 Signals bit 0 mask. */
#define PORTMUX_USART50_bp  2  /* USART5 Signals bit 0 position. */
#define PORTMUX_USART51_bm  (1<<3)  /* USART5 Signals bit 1 mask. */
#define PORTMUX_USART51_bp  3  /* USART5 Signals bit 1 position. */
...
#define PORTMUX_TCB4_bm  0x10  /* TCB4 Output bit mask. */
#define PORTMUX_TCB4_bp  4  /* TCB4 Output bit position. */
...
#define PORTMUX_ZCD2_bm  0x04  /* Zero Cross Detector 2 Output bit mask. */
#define PORTMUX_ZCD2_bp  2  /* Zero Cross Detector 2 Output bit position. */
...
#define PORTG_PORT_vect_num  59
#define PORTG_PORT_vect      _VECTOR(59)  /*  */
...
#define _VECTORS_SIZE (65 * _VECTOR_SIZE)
...
#endif /* #ifdef _AVR_AVR128DB64_H_INCLUDED */
